...
const QColor &LearnQtLogo::bgColor() const
{
    return m_bgColor;
}
...
const QColor &LearnQtLogo::textColor() const
{
    return m_textColor;
}
...
const QString &LearnQtLogo::text() const
{
    return m_text;
}
...
const LearnQtLogo::QtTopic &LearnQtLogo::topic() const
{
    return m_topic;
}

void LearnQtLogo::setTopic(const QtTopic &newTopic)
{
    if (m_topic == newTopic)
        return;
    m_topic = newTopic;
